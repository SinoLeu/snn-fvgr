...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        trainset = datasets.ImageFolder(root=f'{args.data_root}/train', transform=transform)
        testset = datasets.ImageFolder(root=f'{args.data_root}/test', transform=transform)
        ...
        # testset = CarsDataset(os.path.join(args.data_root,'devkit/cars_test_annos.mat'),
