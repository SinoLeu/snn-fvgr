...
class LitModel(pl.LightningModule):
    def __init__(self, num_classes, learning_rate=0.1, transfer=True,resnet_scale:str = '50',load_checkpoints_path:str="./logs/fine_tune_resnet50/version_8/checkpoints/best_model.ckpt"):
        super().__init__()
    ...
    def training_step(self, batch):
        ...
        loss = self.refine_block.get_fr_loss(gt,y1,y2,vae_loss)
...
## python training-refine-block_ann.py --batch_size 32 --learning_rate 2e-2 --input_size 300 --train_dir '../data/cars/train' --test_dir '../data/cars/test' --resnet_scale '50' --max_epochs 200  --checkpoint_dir 'logs' --num_classes 196 --is_distributed  --is_transfer