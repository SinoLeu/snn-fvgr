...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, return_mid=False) -> Tensor:
    ...
    def forward(self, x: Tensor,return_mid=False) -> Tensor:
        return self._forward_impl(x,return_mid=return_mid)
